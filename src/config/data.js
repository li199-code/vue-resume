export default {
    ...
    `],
	Education: [
		{ school: 'A University', major: 'History', date: '2011.9-2015.6', description: '' },
		{ school: 'B University', major: 'History', date: '2011.9-2015.6', description: '' }
	],
	WorkingExperience: [
		{
			company: 'Google',
